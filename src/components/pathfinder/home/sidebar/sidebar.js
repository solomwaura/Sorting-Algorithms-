  ...
  return (
    <div className='sidebar'>
            ...
            <div className="locations_container">
                <div className="locations"> 
                    <div className="location">
                        <FaMapMarkerAlt className='source-icon'/>
                ...
                <button className={`swap-button ${disableDirection && 'disable-direction-button'}`} onClick={swapLocations}><FaXing className='swap-icon'/></button>
            </div>
        ...
        <div className="parent-button-group">
            <button className={`button navigation-button ${disableNavigation && 'disable-button'}`} onClick={startNavigation}><FaSortUp className='location-icon'/> Start Navigation</button>
